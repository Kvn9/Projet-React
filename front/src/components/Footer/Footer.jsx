          ...
          <div className="max-w-screen-xl mx-auto px-4 md:px-8">
              <div className="justify-between items-center gap-12 md:flex">
                  <div className="flex-1 max-w-lg">
                      ...
                      Une question, une remarque ? <strong className='text-fuchsia-500'> <br></br>N'hésitez pas à nous en informer !</strong>
                      </h3>
                  </div>
                  <div className="flex-1 mt-6 md:mt-0">
                      <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                          ...
                          <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-purple-500 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow">
                              Abonnez-vous
                          </button>
                      </form>
                  </div>
                              ...
                              </h4>
                              {
                                  item.items.map(((el, idx) => (
                                      <li key={idx}>
                                          <a
                                              href={el.href}
                                              className="duration-150 transition-colors ease-in-out text-gray-300  duration-150 hover:text-fuchsia-500"
