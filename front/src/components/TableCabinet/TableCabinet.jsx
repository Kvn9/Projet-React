...
export default () => {
    ...
    const handleDeleteCabinet = (id) => {
        fetch(`http://localhost:8000/cabinet/deleteCabinet/${id}`, {
            method: 'DELETE',
            headers: {
                            ...
                            tableItems.map((item, idx) => (
                                <tr key={idx}>
                                    <td className="flex items-center gap-x-3 py-3 px-6 whitespace-nowrap">
                                        <div>
                                            <span className="block text-gray-700 text-sm font-medium ">{item.nom}</span>
                                            <span className="block text-gray-700 text-xs">{item.adresse}</span>
                                        </div>
                                    </td>
